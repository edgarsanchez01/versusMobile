...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&display=swap"
        rel="stylesheet" />
    <title>VSMovil | Dispositivos</title>
    <!-- Bootstrap core CSS -->
                    ...
                    <div class="most-popular">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <?php
                // Prepara la consulta SQL para obtener todos los dispositivos ordenados por id_dispositivo en forma descendente
                $sql = "SELECT id_dispositivo, modelo, marca, Announced, visitas, imgP FROM especphones ORDER BY id_dispositivo DESC";
